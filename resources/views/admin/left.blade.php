        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="{{route('dashboard.home')}}" class="" aria-expanded="false">
						<div class="menu-icon">
					...
					<li><a href="{{route('product.index')}}" class="" aria-expanded="false">
						<div class="menu-icon">
					...
					<li><a href="{{route('account.index')}}" class="" aria-expanded="false">
						<div class="menu-icon">
							<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="nav-text">Account and Comment</span>
						</a>
					</li>
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="{{route("dashboard.index")}}">Gener and Brands</a></li>
							<li><a href="{{route("dashboardsize.index")}}">Product-Size</a></li>
						</ul>
					</li>
